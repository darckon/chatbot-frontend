...
import { Loader, OrbitControls, PerspectiveCamera, PresentationControls } from '@react-three/drei'
import Robot from './components/chatbot/Robot'
import Level from './components/environment/stage01/Level'
import Sudo from './components/environment/stage01/Sudo'
import Camera from './components/environment/stage01/Camera'
import Cactus from './components/environment/stage01/Cactus'
import Icon from './components/environment/stage01/Icon'
import SohoTxt from './components/environment/stage01/SohoTxt'
import Chair from './components/environment/stage01/Chair'
import  Form  from 'react-bootstrap/Form'
import  Button  from 'react-bootstrap/Button'
import { Suspense, useRef } from 'react'
import Screen from './components/environment/stage01/Screen'
